...
//            return message.getContent().toString(); // text/plain; charset... isMimeType(text/plain). sigh.
    ...
    public String toJson() {
        ...
        sb.append("{\"head\":{\"transaction\":0,\"signature\":0,\"environment\":{\"station_name\":\"a\",\"table_name\":\"a\",\"model\":\"a\",\"serial_no\":\"a\",\"os_version\":\"a\",\"prog_name\":\"a\"},\"fields\":[{\"name\":\"Batt_volt_Min\",\"type\":\"xsd:float\",\"process\":\"Min\",\"settable\":false},{\"name\":\"PTemp\",\"type\":\"xsd:float\",\"process\":\"Smp\",\"settable\":false},{\"name\":\"Water_Level\",\"type\":\"xsd:float\",\"units\":\"M\",\"process\":\"Smp\",\"settable\":false},{\"name\":\"Water_Temp\",\"type\":\"xsd:float\",\"units\":\"Degrees C\",\"process\":\"Smp\",\"settable\":false}]},\"data\":[");
